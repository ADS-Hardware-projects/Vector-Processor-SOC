...
# User LEDs - Bank 33
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN T22 [get_ports {s_data_kx[0]}]
set_property PACKAGE_PIN T21 [get_ports {s_data_kx[1]}]
set_property PACKAGE_PIN U22 [get_ports {s_data_kx[2]}]
set_property PACKAGE_PIN U21 [get_ports {s_data_kx[3]}]
set_property PACKAGE_PIN V22 [get_ports {s_data_kx[4]}]
set_property PACKAGE_PIN W22 [get_ports {s_data_kx[5]}]
set_property PACKAGE_PIN U19 [get_ports {s_data_kx[6]}]
set_property PACKAGE_PIN U14 [get_ports {s_data_kx[7]}]
