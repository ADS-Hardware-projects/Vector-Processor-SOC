...
# JA Pmod - Bank 13
# ----------------------------------------------------------------------------
# set_property PACKAGE_PIN Y11  [get_ports {m_ready}];  # "JA1"
# set_property PACKAGE_PIN AA8  [get_ports {s_valid}];  # "JA10"
# set_property PACKAGE_PIN AA11 [get_ports {value[2]}];  # "JA2"
...
# JB Pmod - Bank 13
# ----------------------------------------------------------------------------
# set_property PACKAGE_PIN W12 [get_ports m_ready]
# set_property PACKAGE_PIN W11 [get_ports s_valid]
...
## ----------------------------------------------------------------------------
#set_property PACKAGE_PIN F22 [get_ports {button[0]}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {button[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {button[2]}]
#set_property PACKAGE_PIN F21 [get_ports {button[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {button[4]}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {button[5]}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {button[6]}];  # "SW6"
#set_property PACKAGE_PIN M15 [get_ports {button[7]}];  # "SW7"
