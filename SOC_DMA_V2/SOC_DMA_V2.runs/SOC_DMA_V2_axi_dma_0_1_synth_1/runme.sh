...
HD_PWD='D:/Study Materials/Sem 7/ADS/Vector-Processor-SOC/SOC_DMA_V2/SOC_DMA_V2.runs/SOC_DMA_V2_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_DMA_V2_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOC_DMA_V2_axi_dma_0_1.tcl
