...
HD_PWD='D:/Study Materials/Sem 7/ADS/Vector-Processor-SOC/SOC_DMA_V2/SOC_DMA_V2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOC_DMA_V2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOC_DMA_V2_wrapper.tcl -notrace
