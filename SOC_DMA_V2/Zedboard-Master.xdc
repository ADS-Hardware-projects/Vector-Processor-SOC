...
# set_property PACKAGE_PIN AA9  [get_ports {value[4]}];  # "JA4"
# set_property PACKAGE_PIN AB11 [get_ports {value[5]}];  # "JA7"
# set_property PACKAGE_PIN AB10 [get_ports {value[6]}];  # "JA8"
# set_property PACKAGE_PIN AB9  [get_ports {value[7]}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ----------------------------------------------------------------------------
# set_property PACKAGE_PIN W12 [get_ports {m_valid}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {m_ready}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {par_data[0]}];  # "JB3"
#set_property PACKAGE_PIN W8 [get_ports {s_data_kx[7]}];  # "JB4"
...
#set_property PACKAGE_PIN AA4 [get_ports {value2[2]}];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {value2[3]}];  # "JC2_P"
#set_property PACKAGE_PIN T6  [get_ports {value2[4]}];  # "JC3_N"
#set_property PACKAGE_PIN R6  [get_ports {value2[5]}];  # "JC3_P"
#set_property PACKAGE_PIN U4  [get_ports {value2[6]}];  # "JC4_N"
#set_property PACKAGE_PIN T4  [get_ports {value2[7]}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN W7 [get_ports {value3[0]}];  # "JD1_N"
#set_property PACKAGE_PIN V7 [get_ports {value3[1]}];  # "JD1_P"
#set_property PACKAGE_PIN V4 [get_ports {value3[2]}];  # "JD2_N"
#set_property PACKAGE_PIN V5 [get_ports {value3[3]}];  # "JD2_P"
#set_property PACKAGE_PIN W5 [get_ports {value3[4]}];  # "JD3_N"
#set_property PACKAGE_PIN W6 [get_ports {value3[5]}];  # "JD3_P"
#set_property PACKAGE_PIN U5 [get_ports {value3[6]}];  # "JD4_N"
#set_property PACKAGE_PIN U6 [get_ports {value3[7]}];  # "JD4_P"
...
# HDMI Output - Bank 33
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN W18  [get_ports {count_reg[23]}];  # "HD-CLK"
#set_property PACKAGE_PIN Y13  [get_ports {count_reg[22]}];  # "HD-D0"
#set_property PACKAGE_PIN AA13 [get_ports {count_reg[21]}];  # "HD-D1"
#set_property PACKAGE_PIN W13  [get_ports {count_reg[20]}];  # "HD-D10"
#set_property PACKAGE_PIN W15  [get_ports {count_reg[19]}];  # "HD-D11"
#set_property PACKAGE_PIN V15  [get_ports {count_reg[18]}];  # "HD-D12"
#set_property PACKAGE_PIN U17  [get_ports {count_reg[17]}];  # "HD-D13"
#set_property PACKAGE_PIN V14  [get_ports {count_reg[16]}];  # "HD-D14"
#set_property PACKAGE_PIN V13  [get_ports {count_reg[15]}];  # "HD-D15"
#set_property PACKAGE_PIN AA14 [get_ports {count_reg[14]}];  # "HD-D2"
#set_property PACKAGE_PIN Y14  [get_ports {count_reg[13]}];  # "HD-D3"
#set_property PACKAGE_PIN AB15 [get_ports {count_reg[12]}];  # "HD-D4"
#set_property PACKAGE_PIN AB16 [get_ports {count_reg[11]}];  # "HD-D5"
#set_property PACKAGE_PIN AA16 [get_ports {count_reg[10]}];  # "HD-D6"
#set_property PACKAGE_PIN AB17 [get_ports {count_reg[9]}];  # "HD-D7"
#set_property PACKAGE_PIN AA17 [get_ports {count_reg[8]}];  # "HD-D8"
#set_property PACKAGE_PIN Y15  [get_ports {count_reg[7]}];  # "HD-D9"
#set_property PACKAGE_PIN U16  [get_ports {count_reg[6]}];  # "HD-DE"
#set_property PACKAGE_PIN V17  [get_ports {count_reg[5]}];  # "HD-HSYNC"
#set_property PACKAGE_PIN W16  [get_ports {count_reg[4]}];  # "HD-INT"
#set_property PACKAGE_PIN AA18 [get_ports {count_reg[3]}];  # "HD-SCL"
#set_property PACKAGE_PIN Y16  [get_ports {count_reg[2]}];  # "HD-SDA"
#set_property PACKAGE_PIN U15  [get_ports {count_reg[1]}];  # "HD-SPDIF"
#set_property PACKAGE_PIN Y18  [get_ports {count_reg[0]}];  # "HD-SPDIFO"
#set_property PACKAGE_PIN W17  [get_ports {count_reg[31]}];  # "HD-VSYNC"
...
#set_property PACKAGE_PIN U19 [get_ports {s_data_kx[6]}];  # "LD6"
#set_property PACKAGE_PIN U14 [get_ports {s_valid}];  # "LD7"
...
# ----------------------------------------------------------------------------
#set_property PACKAGE_PIN P16 [get_ports {rstn}];  # "BTNC"
...
## ----------------------------------------------------------------------------
#set_property PACKAGE_PIN F22 [get_ports {rstn}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {par_data[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {par_data[2]}];  # "SW2"
