...
(
    ...
    logic [wordSize * words - 1: 0] regColumn; // this will hold the column to multiply
    logic [$clog2(NoOfElem) + 1: 0]regAddrCounter; // this will control the writing address of the register file
    logic ProcessBegin;
    ...
    always @(posedge clk or negedge RESET) begin
        ...
        if(!RESET) begin
            ...
            FURESET <= 0; // fetch unit reset
            MEMWRRESET <= 0; // memmmory writer reset
            PEEnable <= 0; // resetting all processing elements
